...
let me = {
  firstname: "Eric",
  superHeroName: "Gallo Negro",
  homeTown: "G-Town",
  superPowerXP: ["feed the poor", "cure cancer", "teleport"],
  profileImage:
...
function redactInfo(obj) {
  for (let key in me) {
    console.log(me[key]);
    delete me.superHeroName;
    delete me.superPowerXP;
  }
  redacted();
}
console.log(me.superHeroName);
